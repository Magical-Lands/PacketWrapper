...
public class WrapperPlayServerEntityMetadata extends AbstractPacket {
   ...
   */
  public void setMetadata(List<WrappedDataValue> values) {
    handle.getDataValueCollectionModifier().write(0, values);
  }

  public void setIndex(int index, Object value, Serializer serializer) {
    List<WrappedDataValue> values = this.getMetadata();

    values.removeIf(wrappedDataValue -> wrappedDataValue.getIndex() == index);
